      ...
      if (contentController.text != '') {
        ...
        if (selectedImages.isNotEmpty) {
          ...
          for (File img in selectedImages) {
            final path = '${postcount + 1}/${img.path}';
            final refs = FirebaseStorage.instance.ref().child(path);
            UploadTask uploadTask = refs.putFile(img);
          }
        } else {
        ...
        //cập nhật thông tin bài đăng lên realtime firebase
